    ...
    <>
      ...
      >
        ...
        <nav className="flex flex-col p-4 space-y-4">
          ...
          <Link href="/usluge" className="text-gray-700 hover:text-purple-600">
            Services
          </Link>
          <Link href="/o-nama" className="text-gray-700 hover:text-purple-600">
            About Us
          </Link>
          <Link href="/kontakt" className="text-gray-700 hover:text-purple-600">
            Contact
          </Link>
          <Link
            href="/demo-sajtovi"
